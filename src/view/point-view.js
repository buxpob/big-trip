...
import { renderDiffTime } from '../utils/render.js';
...
const createPointComponent = (point) => {
  const {price, dateStart, dateEnd, type, destination, isFavorite, offers} = point;
...
export default class PointView extends AbstractView {
  ...
  get template() {
    return createPointComponent(this.#point);
  }
